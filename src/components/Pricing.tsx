...
export function Pricing() {
	return (
		<section id="pricing" className="relative min-h-screen overflow-hidden py-24">
			<div className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				>
					...
					<h2 className="mt-5 text-center text-2xl font-bold tracking-tighter md:text-3xl lg:text-4xl">
						Financial Analytics Plans
					</h2>
					<p className="text-muted-foreground mt-5 text-center text-sm md:text-base">
						Take control of your finances with our budget optimization tools. We offer flexible pricing options to match your financial needs.
					</p>
				</motion.div>
					...
					>	
						<div className="grid md:grid-cols-2 bg-background relative border p-4">
							...
							<div className="w-full px-4 pt-5 pb-4">
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Basic Analytics</h3>
										<div className="flex items-center gap-x-1">
											<span className="text-muted-foreground text-sm line-through">$9.99</span>
											<Badge variant="secondary">20% off</Badge>
										</div>
									</div>
									<p className="text-muted-foreground text-sm">Perfect for personal finance tracking!</p>
								</div>
							...
							<div className="relative w-full rounded-lg border px-4 pt-5 pb-4">
								...
								<div className="space-y-1">
									<div className="flex items-center justify-between">
										<h3 className="leading-none font-semibold">Premium Analytics</h3>
										<div className="flex items-center gap-x-1">
											<span className="text-muted-foreground text-sm line-through">$14.99</span>
											<Badge>25% off</Badge>
										</div>
									</div>
									<p className="text-muted-foreground text-sm">Advanced insights with AI budget optimization!</p>
								</div>
								<div className="mt-10 space-y-4">
						...
						<div className="text-muted-foreground flex items-center justify-center gap-x-2 text-sm">
							...
							<span>Both plans include data privacy and smart insights</span>
						</div>
					</motion.div>
				</div>
			</div>

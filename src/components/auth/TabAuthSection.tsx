  ...
  return (
    <section className="fixed inset-0 bg-zinc-950 text-zinc-50">
      ...
      <header className="absolute left-0 right-0 top-0 flex items-center justify-between px-6 py-4 border-b border-zinc-800/80">
        <span className="text-xs tracking-[0.14em] uppercase text-zinc-400">FinPulse</span>
        <a href="/">
          <Button
            variant="outline"
      ...
      <div className="h-full w-full grid place-items-center px-4">
        <Card className="card-animate w-full max-w-md border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60">
          ...
          <CardContent>
            <Tabs defaultValue={defaultTab} className="auth-tabs w-full">
              ...
              <div className="tab-shell mt-6">
                <TabsContent value="login" forceMount className="tab-panel space-y-5">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Checkbox id="remember" className="border-zinc-700 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground" />
                  ...
                  <Button className="w-full h-10 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90">
                    Continue
                  </Button>
                ...
                <TabsContent value="signup" forceMount className="tab-panel space-y-5">
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox id="terms" className="border-zinc-700 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground" />
